...
first_user = User.create(name: 'Lilly', photo: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80', bio: 'Teacher from Poland.', email: 'lilly@mail.com', role: 'admin')
second_user = User.create(name: 'Antonio', photo: 'https://images.unsplash.com/flagged/photo-1570612861542-284f4c12e75f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80', bio: 'Teacher from Colombia.', email: 'antonio@mail.com')
third_user = User.create(name: 'Tom', photo: 'https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80', bio: 'Teacher from EE.UU.', email: 'tom@mail.com')

first_user.password = '1234567'
first_user.password_confirmation = '1234567'

second_user.password = '1234567'
second_user.password_confirmation = '1234567'

third_user.password = '1234567'
third_user.password_confirmation = '1234567'
